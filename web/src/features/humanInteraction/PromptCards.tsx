...
import { approvalOf, canLearn, defaultOpenSections, headlineOf, isConsequential, learnHintOf, severityOf, shownTargetGroups } from "../../approvalModel";
...
export function ApprovalCard({ approval, onResolve }: { approval: Approval; onResolve: (id: string, choice: string, text?: string) => void }) {
