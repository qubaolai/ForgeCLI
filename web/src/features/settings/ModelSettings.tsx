...
import { DEFAULT_TEMPERATURE, DEFAULT_TOP_P, buildInitialModelParams, modelPlaceholder, modelRef, providerAvailabilityCopy, splitModelRef } from "../../modelSettings";
...
export function AddProviderDrawer({ protocols, onClose, onAdd }: {
...
export function AddModelDrawer({ knownProviders, providerSettings, onClose, onEditProvider, onAdd, onSetCurrent }: {
  knownProviders: KnownProvider[];
  providerSettings: Provider[];
  onClose: () => void;
  onEditProvider: () => void;
...
export function CheckpointRow({ checkpoint, onRestore, onPreview }: { checkpoint: Checkpoint; onRestore: (id: string) => void; onPreview: (id: string) => Promise<string> }) {
...
export function ProviderEditor({ provider, known, fields, onSaveProvider }: { provider: Provider; known: KnownProvider; fields: FieldSpec[]; onSaveProvider: (providerId: string, changed: Record<string, string>) => void }) {
...
export function ModelEditor({ provider, model, fields, isCurrent, onSave, onRemove }: { provider: Provider; model: Model; fields: FieldSpec[]; isCurrent: boolean; onSave: (providerId: string, modelId: string, changed: Record<string, string>) => void; onRemove: (providerId: string, modelId: string) => void }) {
